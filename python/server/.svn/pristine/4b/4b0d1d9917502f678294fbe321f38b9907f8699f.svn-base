...
## 图片降噪处理
# from skimage.filter import denoise_tv_chambolle  #  sudo apt-get install python-skimagefrom skimage.restoration import denoise_tv_chambolle  #for new version   need conda
AWS服务器上使用这句   # from skimage.filter import denoise_tv_chambolle  #  sudo apt-get install python-skimage
阿里服务器上使用这句   from skimage.restoration import denoise_tv_chambolle 
